...
public class onepointTester {
	...
	public void testCalculateAllOnePoints() throws InterruptedException {
		...
		assertEquals("Match has already set-score,Cant Have multiple  scores for single match",calcTest.placeBet("set-score 3 5:0", "Zlatan"));
		...
		assertEquals("Match has already set-score,Cant Have multiple  scores for single match",calcTest.placeBet("set-score 2 2:1", "Modric"));
		...
		assertEquals("Match has already set-score,Cant Have multiple  scores for single match",calcTest.placeBet("set-score 3 3:4", "Modric"));
